...
<body>
    ...
    <div class="container">
        <section>
            ...
            <form action="showplans.php" method="POST" enctype="multipart/form-data">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="showplans.php?edit=<?php echo $row['id']; ?>">Edit</a> |
                            <a href="showplans.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this recipe?')">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
